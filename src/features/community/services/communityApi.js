...
export const communityApi = {
  ...
  updatePost: (postId, payload) => apiRequest(`/api/community/posts/${postId}`, { method: 'PUT', body: payload }),
  deletePost: (postId) => apiRequest(`/api/community/posts/${postId}`, { method: 'DELETE' }),
